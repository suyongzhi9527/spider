...
def craw(url, key_word, x):
    ...
    headers = {
        ...
        'User-Agent': r'user-agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.92 Safari/537.36',
        'Referer': re,
        'Accept-Encoding': 'gzip, deflate, br',
        'Accept-Language': 'zh-CN,zh;q=0.9',
        'Cookie': r'QCCSESSID=hfo9tdqvhpjbu35va408s4lfe5; zg_did=%7B%22did%22%3A%20%22172a28075a5718-0d93c3add72a28-5f472815-1fa400-172a28075a63d0%22%7D; Hm_lvt_78f134d5a9ac3f92524914d0247e70cb=1591864227; Hm_lpvt_78f134d5a9ac3f92524914d0247e70cb=1591864227; hasShow=1; _uab_collina=159186422743054802031114; acw_tc=b73d7cc215918642272094110ea6ec36f3bf9d43a3621b30b89b9f5144; zg_de1d1a35bfa24ce29bbf2c7eb17e6c4f=%7B%22sid%22%3A%201591864227254%2C%22updated%22%3A%201591864227614%2C%22info%22%3A%201591864227258%2C%22superProperty%22%3A%20%22%7B%7D%22%2C%22platform%22%3A%20%22%7B%7D%22%2C%22utm%22%3A%20%22%7B%7D%22%2C%22referrerDomain%22%3A%20%22diag.qichacha.com%22%7D',
    }
...
if __name__ == '__main__':
    ...
    # 保存excel文件，有同名的直接覆盖
    workbook.save(r"F:\爬虫\企查查" + time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()) + ".xls")
    print('保存完毕~')
