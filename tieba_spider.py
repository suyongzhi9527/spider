...
class TiebaSpider:
    ...
    def get_content_list(self,html_str):
        ...
        for li in li_list:
            item = {}
            item['author'] = li.xpath(".//span[@class='ti_author']/text()")[0] if len(li.xpath(".//span[@class='ti_author']/text()")) > 0 else None
            item['time'] = li.xpath(".//span[@class='ti_time']/text()")[0] if len(li.xpath(".//span[@class='ti_time']/text()")) > 0 else None
